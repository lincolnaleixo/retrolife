...
### Changed
- Added a protected local-Keychain signing mode for the trusted Apple Silicon release runner, while retaining hosted App Store Connect API-key notarization and keeping private signing material off the repository.
