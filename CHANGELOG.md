...
### Fixed
- Keep development-only collection labels out of release exports with an export exclusion and a verify-stage refusal, verify staged label files against the recorded SHA-256 before use, and preserve semantic title words and sequel numbers in collection label matching.
